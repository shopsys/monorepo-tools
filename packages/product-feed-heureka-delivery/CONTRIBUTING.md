...
Thank you for contributing to product-feed-heureka-delivery!
...
- The build of your branch on [Travis CI](https://travis-ci.org/shopsys/product-feed-heureka-delivery/branches) must be passing (your branch will be automatically built after push).
