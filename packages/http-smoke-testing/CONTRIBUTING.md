...
Thank you for contributing to http-smoke-testing!
...
- The build of your branch on [Travis CI](https://travis-ci.org/shopsys/http-smoke-testing/branches) must be passing (your branch will be automatically built after push).
