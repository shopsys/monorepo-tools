...
Thank you for contributing to plugin-interface!
...
- The build of your branch on [Travis CI](https://travis-ci.org/shopsys/plugin-interface/branches) must be passing (your branch will be automatically built after push).
