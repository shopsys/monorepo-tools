...
* [Installation via Docker (recommended)](https://github.com/shopsys/shopsys/docs/docker/installation/installation-using-docker.md)
* [Native installation](https://github.com/shopsys/shopsys/docs/introduction/installation-guide.md)
