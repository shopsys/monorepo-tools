...
Thank you for contributing to migrations!
...
- The build of your branch on [Travis CI](https://travis-ci.org/shopsys/migrations/branches) must be passing (your branch will be automatically built after push).
