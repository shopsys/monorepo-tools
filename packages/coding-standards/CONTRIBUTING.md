...
Thank you for contributing to coding-standards!
...
- You must follow our coding standards (You can see the rulesets in this repository).
- The build of your branch on [Travis CI](https://travis-ci.org/shopsys/coding-standards/branches) must be passing (your branch will be automatically built after push).
