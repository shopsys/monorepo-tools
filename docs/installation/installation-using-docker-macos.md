...
**This guide is for the version which is not released yet. See the [version for `v7.1.1`](https://github.com/shopsys/shopsys/blob/v7.1.1/docs/installation/installation-using-docker-macos.md).**
