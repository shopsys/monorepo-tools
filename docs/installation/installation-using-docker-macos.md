...
**This guide is for the version which is not released yet. See the [version for `v7.3.0`](https://github.com/shopsys/shopsys/blob/v7.3.0/docs/installation/installation-using-docker-macos.md).**
