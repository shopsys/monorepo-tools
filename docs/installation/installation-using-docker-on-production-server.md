...
**This guide is for the version which is not released yet. See the [version for `v7.0.1`](https://github.com/shopsys/shopsys/blob/v7.0.1/docs/installation/installation-using-docker-on-production-server.md).**
