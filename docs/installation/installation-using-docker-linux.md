...
**This guide is for the version which is not released yet. See the [version for `v7.0.0-beta6`](https://github.com/shopsys/shopsys/blob/v7.0.0-beta6/docs/installation/installation-using-docker-linux.md).**
