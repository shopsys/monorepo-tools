...
**This guide is for the version which is not released yet. See the [version for `v7.2.2`](https://github.com/shopsys/shopsys/blob/v7.2.2/docs/installation/installation-using-docker-linux.md).**
