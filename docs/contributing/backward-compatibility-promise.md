...
### Backend API
The API has its own versioning that is independent from the framework versioning. Read [API Versioning](/docs/backend-api/api-versioning.md) for more information.
