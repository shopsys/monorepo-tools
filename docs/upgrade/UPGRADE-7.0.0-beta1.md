# [Upgrade from 7.0.0-alpha6 to 7.0.0-beta1](https://github.com/shopsys/shopsys/compare/v7.0.0-alpha6...v7.0.0-beta1)

This guide contains instructions to upgrade from version 7.0.0-alpha6 to 7.0.0-beta1.
