# [Upgrade from 7.0.0-beta1 to 7.0.0-beta2](https://github.com/shopsys/shopsys/compare/v7.0.0-beta1...v7.0.0-beta2)

This guide contains instructions to upgrade from version 7.0.0-beta1 to 7.0.0-beta2.
