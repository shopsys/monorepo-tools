...
class MailController extends Controller {
	...
	private function getOrderStatusVariablesLabels() {
		...
		return array(
			...
			OrderMailService::VARIABLE_TRANSPORT_INSTRUCTIONS => $translator->trans('Instrukce k dopravě'),
			OrderMailService::VARIABLE_PAYMENT_INSTRUCTIONS => $translator->trans('Instrukce k platbě'),
		);
	}
