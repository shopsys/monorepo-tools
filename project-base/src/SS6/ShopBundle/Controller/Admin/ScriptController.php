...
class ScriptController extends AdminBaseController {
	...
	public function listAction() {
		...
		$grid->addColumn('name', 's.name', 'Název skriptu');
		$grid->addColumn('placement', 's.placement', 'Umístění');
		$grid->addActionColumn('edit', 'Upravit', 'admin_script_edit', ['scriptId' => 's.id']);
		$grid->addActionColumn('delete', 'Smazat', 'admin_script_delete', ['scriptId' => 's.id'])
