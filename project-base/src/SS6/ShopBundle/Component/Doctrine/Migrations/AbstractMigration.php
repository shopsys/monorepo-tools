...
namespace SS6\ShopBundle\Component\Doctrine\Migrations;
...
abstract class AbstractMigration extends DoctrineAbstractMigration {
	...
	protected function addSql($sql, array $params = [], array $types = []) {
		...
		throw new \SS6\ShopBundle\Component\Doctrine\Migrations\Exception\MethodIsNotAllowedException($message);
	}
