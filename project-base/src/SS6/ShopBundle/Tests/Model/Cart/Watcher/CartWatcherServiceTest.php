...
class CartWatcherServiceTest extends FunctionalTestCase {
	...
	public function testShowErrorOnModifiedItems() {
		...
		$product = new Product(new ProductData('Product 1', null, null, null, null, 100));
		...
		$product->edit(new ProductData('Product 1', null, null, null, null, 200, null, null, null, null));
		$cartWatcherService->showErrorOnModifiedItems($cart);
