...
class CartServiceTest extends PHPUnit_Framework_TestCase {
	...
	public function testAddProductToCartInvalidFloatQuantity() {
		...
		$price = 100;
		$product = new Product(new ProductData('Product 1', null, null, null, null, $price));
	...
	public function testMergeCarts() {
		...
		$price = 100;
		$product1 = new Product(new ProductData('Product 1', null, null, null, null, $price));
		$product2 = new Product(new ProductData('Product 2', null, null, null, null, $price));
