...
class ImageLocatorTest extends PHPUnit_Framework_TestCase {
	...
	public function testGetRelativeImagePathProvider() {
		return [
			['entity', 'type', 'size', 'entity' . DIRECTORY_SEPARATOR . 'type' . DIRECTORY_SEPARATOR . 'size' . DIRECTORY_SEPARATOR],
			['entity', 'type', null, 'entity' . DIRECTORY_SEPARATOR . 'type' . DIRECTORY_SEPARATOR],
			['entity', null, 'size', 'entity' . DIRECTORY_SEPARATOR . 'size' . DIRECTORY_SEPARATOR],
			['entity', null, null, 'entity' . DIRECTORY_SEPARATOR],
		];
	}
