...
class ProductDataFixture extends AbstractFixture {
	...
	public function load(ObjectManager $manager) {
		...
		$this->createProduct($manager, 'product_5', new ProductData('Koncept', null, null, null, 'Ještě nevím.', null, null, null, null, true));
