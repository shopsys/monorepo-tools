...
class ProductData extends AbstractFixture {
	 ...
	 */
	private function createProduct(ObjectManager $manager, $referenceName, $name, $catnum, $partno, $ean, $description, $price, $sellingFrom, $sellingTo, $stockQuantity, $hidden) {
