...
class ArticleDataFixture extends AbstractReferenceFixture {
	...
	public function load(ObjectManager $manager) {
		...
		$this->createArticle($manager, $articleData);
	 ...
	 */
	private function createArticle(ObjectManager $manager, ArticleData $articleData) {
