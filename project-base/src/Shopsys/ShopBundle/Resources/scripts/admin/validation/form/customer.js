		...
		$customerDeliveryAddressForm.jsFormValidator({
			'groups': function () {
				...
				if ($customerDeliveryAddressForm.find('#customer_form_deliveryAddressData_addressFilled').is(':checked')) {
					groups.push(Shopsys.constant('\\Shopsys\\ShopBundle\\Form\\Admin\\Customer\\DeliveryAddressFormType::VALIDATION_GROUP_DIFFERENT_DELIVERY_ADDRESS'));
				}
		...
		$customerBillingAddressForm.jsFormValidator({
			'groups': function () {
				...
				if ($customerBillingAddressForm.find('#customer_form_billingAddressData_companyCustomer').is(':checked')) {
					groups.push(Shopsys.constant('\\Shopsys\\ShopBundle\\Form\\Admin\\Customer\\BillingAddressFormType::VALIDATION_GROUP_COMPANY_CUSTOMER'));
				}
